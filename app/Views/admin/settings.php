...
<form action="/admin/settings" method="post" class="card p-4" style="max-width:480px;">
    <?= csrf_field() ?>

    <div class="mb-3">
        <label class="form-label">무료 요금제 월 링크 한도 (개)</label>
